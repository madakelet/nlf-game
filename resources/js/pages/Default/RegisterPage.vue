                ...
                <div class="col-md-8 col-lg-5 register-form p-5">
                    ...
                    <div class="mb-4">
                        <input-component
                            ...
                            v-model="form.name"
                        ></input-component>
                        <error-component :message="errors.name"></error-component>
                    </div>
                    <div class="mb-4">
                        <input-component
                    ...
                    <div class="mb-4">
                        ...
                        ></input-component>
                        <error-component :message="errors.password"></error-component>
                    </div>
                    <div class="mb-4">
                        <input-component
                            label="jelszó újra"
                    ...
                    <select-team-component></select-team-component>
...
export default {
    name: "RegisterPage",
    setup() {
        const { form, register, placeHolderRandomName, randomName, route, errors } =
            useRegister();
        onMounted(() => {
            randomName();
