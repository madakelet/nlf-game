...
class WeekSeeder extends Seeder
{
    ...
    {
        $this->getWeekSeasonType(2023, 2);
        $this->getWeekSeasonType(2023, 3);
    }
    ...
    public function getWeekSeasonType($year, $type)
    {
        $max = $type == 2 ? 18 : 5;
        for ($i = 1; $i <= $max; $i++) {
            $response = file_get_contents("http://sports.core.api.espn.com/v2/sports/football/leagues/nfl/seasons/" .
                $year .
                "/types/" .
                $type .
                "/weeks/" .
